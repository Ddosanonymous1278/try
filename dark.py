...
TELEGRAM_BOT_TOKEN = '7281419606:AAGRk9FouVdtjXpn0gLfOErRicOEW1eq-ko'
ADMIN_USER_ID = 6321758394
...
async def start(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        await context.bot.send_message(chat_id=chat_id, text="*⚡️VIP⋆𝗗𝗗𝗢𝗦⋆𝗛𝗔𝗖𝗞 ☠️\n━━━━━━━━━━━━━━━━━━━━━━━━━━\n 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗛𝗼𝗺𝗲 🪂\n 𝗬𝗼𝘂𝗿 𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗽𝘁𝗶𝗼𝗻 𝗦𝘁𝗮𝘁𝘂𝘀: inactive ❌\n\n🎮 𝗕𝗮𝘀𝗶𝗰 𝗖𝗼𝗺𝗺𝗮𝗻𝗱s\n• /attack - 𝗟𝗮𝘂𝗻𝗰𝗵 𝗔𝘁𝘁𝗮𝗰𝗸\n• /redeem - 𝗔𝗰𝘁𝗶𝘃𝗮𝘁𝗲 𝗟𝗶𝗰𝗲𝗻𝘀𝗲\n\n💡 𝗡𝗲𝗲𝗱 𝗮 𝗸𝗲𝘆?\n𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘂𝗿 𝗔𝗱𝗺𝗶𝗻𝘀 𝗢𝗿 𝗥𝗲𝘀𝗲𝗹𝗹𝗲𝗿𝘀\n\n📢 𝗢𝗳𝗳𝗶𝗰𝗶𝗮𝗹 𝗖𝗵𝗮𝗻𝗻𝗲𝗹: @Sanjai10_oct_2k03*", parse_mode='Markdown')
        return
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥SEND ME FEEDBACK  @Sanjai10_oct_2k03💥*"
    ),
    parse_mode='Markdown'
)
